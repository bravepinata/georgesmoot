...
<div class="bg-gray-900">
  <header class="absolute inset-x-0 top-0 z-50">
    <nav aria-label="Global" class="flex items-center justify-between sm:justify-center md:justify-center lg:justify-center p-6 lg:px-8">
      <!-- logo removed, keep center items only -->
      <!-- hamburger hidden at sm and up -->
